    ...
    <div class="col-md-6">
        ...
        <div class="portlet box blue  b">
            ...
            <div class="portlet-body form">
                {!! Form::open(['url' =>'addSubMenuInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                <div class="form-body">
                    <div class="col-md-12"> 
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Sub Menu Name <span style="color:red; font-weight: bold">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control spinner" name="name" required>
                            </div>
                        </div> 
                        <div class="form-group">
                            <label class="col-md-4 control-label">Sub Menu Status <span style="color:red; font-weight: bold">*</span></label>
                            <div class="col-md-8">
                            <select type="text" class="form-control spinner" name="status" required="">
                                <option value="">Select Sub Menu Status</option>
