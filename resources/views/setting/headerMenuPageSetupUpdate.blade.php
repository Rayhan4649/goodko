    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue  b">
            ...
            <div class="portlet-body form">
                 {!! Form::open(['url' =>'editHeaderMenuPageSetup','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                <div class="form-body">
                    <div class="col-md-12">
                                        ...
                                        <table class="table table-striped table-hover table-bordered" >
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="{{URL::to('headerActionChange/'.$value->id.'/'.$value->heder_menu_id.'/'.$value->status)}}" title="">
                                                ...
                                                <?php else: ?>
                                                  ...
                                                  <?php endif; ?>
                                                    ...
                                                    <td><a href="{{URL::to('editheaderMenuPageSetupUpdateInfo/'.$value->id.'/'.$value->heder_menu_id)}}" title="">
                                                    <button type="button" class="btn btn-info btn-sm">EDIT</button>
                                                    </a>
                                                    </td>
                                                     <td><a href="{{URL::to('deleteHeaderMenuPageSetupUpdateInfo/'.$value->id.'/'.$value->heder_menu_id)}}" title="">
