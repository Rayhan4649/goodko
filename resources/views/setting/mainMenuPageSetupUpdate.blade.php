    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue  b">
            ...
            <div class="portlet-body form">
                 {!! Form::open(['url' =>'editMainMenuPageSetup','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                <div class="form-body">
                    <div class="col-md-12">
                    <h4><center><strong><?php echo $main_menu_info->main_menu_name ; ?></strong></center></h4> 
                    <hr/> 
                                        
                        <div class="form-group">
                            <label class="col-md-2 control-label">Title</label>
                            <div class="col-md-10">
                                <input type="text" class="form-control spinner" name="title" value="<?php echo $row->name ;?>">
                            </div>
                        </div> 
                         <div class="form-group">
                            <label class="col-md-2 control-label">Content</label>
                            <div class="col-md-10">
                                <textarea id="summernote" name="des"><?php echo $row->des ; ?></textarea>                                
                            </div>
                        </div>
                    </div>
                ...
                <?php } ?></td>
                                                    ...
                                                    <a href="{{URL::to('mainActionChange/'.$value->id.'/'.$value->main_menu_id.'/'.$value->status)}}" title="">
                                                    ...
                                                    <td><a href="{{URL::to('editmainMenuPageSetupUpdateInfo/'.$value->id.'/'.$value->main_menu_id)}}" title="">
                                                    <button type="button" class="btn btn-info btn-sm">EDIT</button>
                                                    </a></td> 
                                                    <td><a href="{{URL::to('deleteMainMenuPageSetupUpdateInfo/'.$value->id.'/'.$value->main_menu_id)}}" title="">
                                                    <button type="button" class="btn btn-danger btn-sm">DELETE</button>
                                                    </a></td>
                                                     <td>
                                                    <a href="{{URL::to('subMenuPageLink/'.$value->id.'/'.$value->main_menu_id)}}" title="">
