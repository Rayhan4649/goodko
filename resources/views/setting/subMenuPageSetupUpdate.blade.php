    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue  b">
            ...
            <div class="portlet-body form">
                 {!! Form::open(['url' =>'editSubMenuPageSetup','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                <div class="form-body">
                    <div class="col-md-12">
                    <h4><center><strong><?php echo $sub_menu_info->sub_menu_name ; ?></strong></center></h4> 
                    <hr/> 
                                        ...
                                        <table class="table table-striped table-hover table-bordered" >
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="{{URL::to('subActionChange/'.$value->id.'/'.$value->sub_menu_id.'/'.$value->status)}}" title="">
                                                ...
                                                <?php else: ?>
                                                  ...
                                                  <?php endif; ?>
                                                    ...
                                                    <td><a href="{{URL::to('editsubMenuPageSetupUpdateInfo/'.$value->id.'/'.$value->sub_menu_id)}}" title="">
                                                    <button type="button" class="btn btn-info btn-sm">EDIT</button>
                                                    </a>
                                                   </td>
                                                    <td>
                                                    <a href="{{URL::to('deleteSubMenuPageSetupUpdateInfo/'.$value->id.'/'.$value->sub_menu_id)}}" title="">
