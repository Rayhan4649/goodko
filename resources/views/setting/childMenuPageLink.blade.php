    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue  b">
            ...
            <div class="portlet-body form">
                 {!! Form::open(['url' =>'editChildMenuPageLink','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                <div class="form-body">
                    <div class="col-md-12">
                    ...
                    <input type="hidden" name="main_title_id" value="<?php echo $main_title_id ; ?>" required="">
                     <div class="col-md-12">
                ...
                <?php } ?></td>
                                                    ...
                                                    <a href="{{URL::to('childLinkActionChange/'.$value->id.'/'.$value->main_menu_id.'/'.$value->main_title_id.'/'.$value->sub_link_id.'/'.$value->status)}}" title="">
                                                    ...
                                                    <td><a href="{{URL::to('editChildLinkPageUpdateInfo/'.$value->id.'/'.$value->main_menu_id.'/'.$value->main_title_id.'/'.$value->sub_link_id)}}" title="">
                                                    <button type="button" class="btn btn-info btn-sm">EDIT</button>
                                                    </a>
                                                    </td> 
                                                    <td><a href="{{URL::to('deleteChildLinkPageUpdateInfo/'.$value->id.'/'.$value->main_menu_id.'/'.$value->main_title_id.'/'.$value->sub_link_id)}}" title="">
