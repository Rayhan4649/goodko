    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue  b">
            ...
            <div class="portlet-body form">
                 {!! Form::open(['url' =>'editChildMenuPageSetup','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                <div class="form-body">
                    <div class="col-md-12">
                    <h4><center><strong><?php echo $child_menu_info->chaild_menu_name ; ?></strong></center></h4> 
                    <hr/> 
                                        ...
                                        <table class="table table-striped table-hover table-bordered" >
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="{{URL::to('childActionChange/'.$value->id.'/'.$value->child_menu_id.'/'.$value->status)}}" title="">
                                                ...
                                                <?php else: ?>
                                                  ...
                                                  <?php endif; ?>
                                                    ...
                                                    <td><a href="{{URL::to('editchildMenuPageSetupUpdateInfo/'.$value->id.'/'.$value->child_menu_id)}}" title="">
                                                    <button type="button" class="btn btn-info btn-sm">EDIT</button>
                                                    </a></td>
                                                      <td><a href="{{URL::to('deleteChildMenuPageSetupUpdateInfo/'.$value->id.'/'.$value->child_menu_id)}}" title="">
