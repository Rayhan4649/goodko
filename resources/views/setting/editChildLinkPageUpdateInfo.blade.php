    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue  b">
            ...
            <div class="portlet-body form">
                {!! Form::open(['url' =>'editChildLinkPageUpdateInfoo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                <div class="form-body">
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                                <label class="col-md-4 control-label">Quotation</label>
                                    <div class="col-md-8">
                                        <input type="file" class="form-control spinner" name="document">
                                </div>
                        </div>
                    ...
                    <input type="hidden" name="main_title_id" value="<?php echo $main_title_id ; ?>">
                    <input type="hidden" name="sub_link_id" value="<?php echo $sub_link_id ; ?>">
                    <center>
                        <div class="form-group">
                            <div class="col-md-12">
