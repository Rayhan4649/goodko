 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'updateManagerInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                                            <div class="form-body">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-8">
                                                    <input type="text" name="branch_id" class="form-control spinner" value="<?php echo $value->manager_name; ?>" disabled>
                                                  </div>
                                              </div>
