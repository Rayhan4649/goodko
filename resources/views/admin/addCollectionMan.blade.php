 ...
 <div class="col-md-8">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'addCollectionManInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                                            <div class="form-body">

                                              <div class="form-group">
                                                <label class="col-md-4 control-label">Collection Man Name <span style="color:red; font-weight: bold">*</span></label>
                                                <div class="col-md-8">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                <label class="col-md-4 control-label">Login Mobile (Log In Id)<span style="color:red; font-weight: bold">*</span></label>
                                                <div class="col-md-8">
