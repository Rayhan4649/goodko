...
<html lang="en">
    ...
    <body class="">
        <div class="page-lock">
            ...
            <div class="page-body">
                <div class="lock-head"> ENTER INTO SYSTEM USING OTP </div>
                <div class="lock-body">
                    <div class="lock-cont">
                        <div class="lock-item">
...
@endif
        ...
        {!! Form::open(['url' => 'loginUsingOtp','method' => 'post' , 'class'=> 'lock-form pull-left' ]) !!}
                                    <div class="form-group">
                                    <input class="form-control placeholder-no-fix" type="number" autocomplete="off" placeholder="OTP" name="otp" required="" /> 
                                </div>
                ...
                <div class="lock-bottom">
                    <a href="{{URL::to('resendotp')}}" >Re-Send</a>
                </div>
            </div>
