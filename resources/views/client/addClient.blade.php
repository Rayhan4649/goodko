    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue  b">
            ...
            <div class="portlet-body form">
                {!! Form::open(['url' =>'addClientInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                <div class="form-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control spinner" name="client_name" required>
                            </div>
                        </div> 
                        <div class="form-group">
                            <label class="col-md-4 control-label">Client'S Institution <span style="color:red; font-weight: bold"></span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control spinner" name="client_institution">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control spinner" name="softwar_price">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Server Fee/month <span style="color:red; font-weight: bold"></span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control spinner" name="server_fee">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label class="col-md-4 control-label">Address <span style="color:red; font-weight: bold"></span></label>
                            <div class="col-md-8"> 
                                <textarea type="text" class="form-control spinner" name="address"></textarea>
                            </div>
                        </div> 
                        <div class="form-group">
                            <label class="col-md-4 control-label">Client Image <span style="color:red; font-weight: bold"></span></label>
                            <div class="col-md-8">
